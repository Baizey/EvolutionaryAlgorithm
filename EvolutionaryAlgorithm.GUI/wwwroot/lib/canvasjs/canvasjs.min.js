...
(function () {
    ...
    function N(k, m) {
        ...
        }[k || "solid"]) for (var s = 0; s < v.length; s++) v[s] *= m; else v = [];
        return v
    }
    ...
    function xa(k, m) {
        ...
        if (s(this.options.margin) && k.options.subtitles) for (var v = k.options.subtitles, u = 0; u < v.length; u++) if ((s(v[u].horizontalAlign) && "center" === this.horizontalAlign || v[u].horizontalAlign === this.horizontalAlign) && (s(v[u].verticalAlign) && "top" === this.verticalAlign || v[u].verticalAlign === this.verticalAlign) && !v[u].dockInsidePlotArea === !this.dockInsidePlotArea) {
            this.margin = 0;
            break
        }
    ...
    var Fa = !1, J = {}, u = !!document.createElement("canvas").getContext, pa = {
        ...
        "Arial", Da = u ? "Impact, Charcoal, sans-serif" : "Arial", ya = {
    ...
    var eb = function () {
            ...
            return function (E, N, M) {
                var I = M ? M.days : m, P = M ? M.months : s, V = M ? M.shortDays : v, Q = M ? M.shortMonths : u;
                M = "";
                var J = !1;
                ...
                M = J ? "getUTC" : "get";
                var W = E[M + "Date"](), L = E[M + "Day"](), X = E[M + "Month"](), a = E[M + "FullYear"](),
                    d = E[M + "Hours"](), c = E[M + "Minutes"](), b = E[M + "Seconds"](), e = E[M + "Milliseconds"](),
            ...
            var s = 0 > k ? !0 : !1;
            s && (k *= -1);
            var u = v ? v.decimalSeparator : ".", y = v ? v.digitGroupSeparator : ",", D = "";
            m = String(m);
            var D = 1, E = v = "", N = -1, M = [], I = [], P = 0, J = 0, V = 0, Q = !1, W = 0,
                E = m.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);
            m = null;
            for (var L = 0; E && L < E.length; L++) if (m = E[L], "." === m && 0 > N) N = L; else {
            ...
            k = (m[1] + "").split("");
            D && "0" === D[0] && D.shift();
            for (Q = E = L = J = N = 0; 0 < M.length;) if (m = M.pop(), "#" === m || "0" === m) if (N++, N === P) {
                var X =
                    D, D = [];
    ...
    W.prototype.set = function (k, m, s) {
        ...
        if ("options" === k) this.createUserOptions(m); else if (u.hasOwnProperty(k) || u.publicProperties && u.publicProperties.hasOwnProperty(k) && "readWrite" === u.publicProperties[k]) this.options._isPlaceholder && this.createUserOptions(), this.options[k] = m; else {
    ...
    W.prototype.addTo = function (k, m, s, u) {
        ...
        y.hasOwnProperty(k) || y.publicProperties && y.publicProperties.hasOwnProperty(k) && "readWrite" === y.publicProperties[k] ? (this.options._isPlaceholder && this.createUserOptions(), "undefined" === typeof this.options[k] && (this.options[k] =
    ...
    W.prototype.updateOption = function (k) {
        ...
        var m = pa[this._defaultsKey], u = {}, y = this[k], E = this._themeOptionsKey,
            J = this._index;
    ...
    W.prototype.removeEventListener = function (k, m) {
        if (k && m && this._eventListeners[k]) for (var s = this._eventListeners[k], u = 0; u < s.length; u++) if (s[u].eventHandler === m) {
            s[u].splice(u, 1);
            break
        }
    };
    ...
    ia.prototype.render = function (k) {
        if (0 !== this.fontSize) {
            ...
            var u = 0, y = this.topPadding, E = null;
            ...
            for (s = 0; s < this._wrappedText.lines.length; s++) {
                ...
                if ("right" === this.horizontalAlign || "right" === this.textAlign) u = this.width - E.width - this.rightPadding; else if ("left" === this.horizontalAlign || "left" === this.textAlign) u = this.leftPadding; else if ("center" === this.horizontalAlign || "center" === this.textAlign) u = (this.width - (this.leftPadding + this.rightPadding)) / 2 - E.width / 2 + this.leftPadding;
    ...
    ia.prototype._getLineWithWidth = function (k, m, s) {
        ...
        var u = s = 0, y = k.length - 1, E = Infinity;
        for (this.ctx.font = this._getFontString(); u <= y;) {
            var E = Math.floor((u + y) / 2), D = k.substr(0, E + 1);
    ...
    ia.prototype._wrapText = function () {
        var k = new String(Ea(String(this.text))), m = [], s = this.ctx.font, u = 0, y = 0;
        this.ctx.font = this._getFontString();
        if (0 === this.frontSize) y = u = 0; else for (; 0 < k.length;) {
            ...
            m.push(D);
            var J = y, y = Math.max(y, D.width), u = u + D.height, k = Ea(k.slice(D.text.length, k.length));
    ...
    y = Na.Chart = function () {
        ...
        m.prototype.renderElements = function () {
            ...
            if (0 < c.length) n.disableToolTip = !0, n._animator.animate(200, n.animationDuration, function (a) {
                ...
                if (n._breaksCanvas) if (u) n.plotArea.ctx.drawImage(n._breaksCanvas, 0, 0, this.width, this.height); else for (h = 0; h < n._axes.length; h++) n._axes[h].createMask();
        ...
        m.prototype._processStackedPlotUnit = function (a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, p = [], l = [], A = Infinity, h = -Infinity, n = 0; n < a.dataSeriesIndexes.length; n++) {
                    var r =
                        this.data[a.dataSeriesIndexes[n]], q = 0, g = !1, w = !1, k;
        ...
        m.prototype._processSpecificPlotUnit =
            function (a) {
                if ("waterfall" === a.type && a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, p = 0; p < a.dataSeriesIndexes.length; p++) {
                    var l = this.data[a.dataSeriesIndexes[p]], A = 0, h = !1, n = !1, r = b = 0;
                    ...
                    for (A = 0; A < l.dataPoints.length; A++) if ("undefined" === typeof l.dataPoints[A].x && (l.dataPoints[A].x = A + (a.axisX.logarithmic ? 1 : 0)), l.dataPoints[A].x.getTime ? (f = !0, b = l.dataPoints[A].x.getTime()) : b = l.dataPoints[A].x, e = l.dataPoints[A].y, b < c.min && (c.min = b), b > c.max && (c.max = b), l.dataPointEOs[A].cumulativeSum <
        ...
        m.prototype.calculateAutoBreaks = function () {
                ...
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                    ...
                    if (b || c) for (var d = a.axisY.dataInfo, f = a.axisX.dataInfo, g, h = f.min, p = f.max, l = d.min, n = d.max, f = f._dataRanges, d = d._dataRanges, q, r = 0, A = 0; A < a.dataSeriesIndexes.length; A++) {
                        ...
                        if (!(4 > k.dataPoints.length)) for (r = 0; r < k.dataPoints.length; r++) if (b && (q = (p + 1 - h) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10) / 100, g = k.dataPoints[r].x.getTime ? k.dataPoints[r].x.getTime() : k.dataPoints[r].x, q = Math.floor((g - h) / q), g < f[q].min && (f[q].min = g), g > f[q].max && (f[q].max = g)), c) {
                            ...
                            if ((g = "waterfall" === a.type ? k.dataPointEOs[r].cumulativeSum : k.dataPoints[r].y) && g.length) for (var u = 0; u < g.length; u++) q =
            ...
            function c(a) {
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length) && a.axisX.scaleBreaks && a.axisX.scaleBreaks.autoCalculate && 1 <= a.axisX.scaleBreaks.maxNumberOfAutoBreaks) for (var b = a.axisX.dataInfo, c = b.min, d = b.max, f = b._dataRanges, g, h = 0, p = 0; p < a.dataSeriesIndexes.length; p++) {
                    ...
                    if (!(4 > l.dataPoints.length)) for (h =
            ...
            if (f) {
                ...
                for (p = 0; p < this._axes.length; p++) if (this._axes[p].dataInfo._dataRanges) {
                    ...
                    if (this._axes[p].dataInfo.dataPointYPositiveSums) {
                        ...
                        n = h;
                        for (l in q) if (q.hasOwnProperty(l) && !isNaN(l) && (r = q[l], !s(r))) {
                    ...
                    for (l = 0; l < h.length -
                    1; l++) if (n = h[l].max, isFinite(n)) for (; l < h.length - 1;) if (A = h[l + 1].min, isFinite(A)) {
                        r = A - n;
                        r > b && f.push({diff: r, start: n, end: A});
                        break
                    } else l++;
                    if (this._axes[p].scaleBreaks.customBreaks) for (l = 0; l < this._axes[p].scaleBreaks.customBreaks.length; l++) for (b = 0; b < f.length; b++) if (this._axes[p].scaleBreaks.customBreaks[l].startValue <= f[b].start && f[b].start <= this._axes[p].scaleBreaks.customBreaks[l].endValue || this._axes[p].scaleBreaks.customBreaks[l].startValue <= f[b].start && f[b].start <= this._axes[p].scaleBreaks.customBreaks[l].endValue ||
        ...
        m.prototype.getObjectAtXY = function (a, d, c) {
            ...
            if (c = this.getDataPointAtXY(a,
                d, c || !1)) b = c.dataSeries.dataPointIds[c.dataPointIndex]; else if (u) b = Xa(a, d, this._eventManager.ghostCtx); else for (c = 0; c < this.legend.items.length; c++) {
        ...
        m.prototype._touchEventHandler = function (a) {
            if (a.changedTouches &&
                ...
                if (!(c && 1 < c.length)) {
                    ...
                    if (this._lastTouchData.scroll && this.zoomEnabled) this.isDrag && this.resetOverlayedCanvas(), this.isDrag = !1; else for (c = 0; c < d.length; c++) if (e = d[c], p = document.createEvent("MouseEvent"), p.initMouseEvent(e, !0, !0, window,
        ...
        m.prototype._mouseEventHandler = function (a) {
            ...
            if (this.interactivityEnabled) if (this._ignoreNextEvent) this._ignoreNextEvent = !1; else if (a.preventManipulation && a.preventManipulation(), a.preventDefault && a.preventDefault(), Fa && window.console && (window.console.log(c + " --\x3e x: " + d.x + "; y:" + d.y), e && window.console.log(a.which), "mouseup" === c && window.console.log("mouseup")), !e) {
        ...
        m.prototype._plotAreaMouseUp = function (a, d) {
            ...
            if ("none" !== this.plotInfo.axisPlacement) {
                ...
                if (this.axisX2 && 0 < this.axisX2.length) for (p =
        ...
        m.prototype.validateRegion = function (a, d, c, b, e) {
            ...
            for (p = 0; p < h.length; p++) {
                var r = h[p], f = !1, q = r.convertPixelToValue({x: a, y: d}), g = r.convertPixelToValue({x: c, y: b});
                if (q > g) var w = g, g = q, q = w;
                if (r.scaleBreaks) for (w = 0; !f && w < r.scaleBreaks._appliedBreaks.length; w++) f = r.scaleBreaks._appliedBreaks[w].startValue <= q && r.scaleBreaks._appliedBreaks[w].endValue >= g;
                if (isFinite(r.dataInfo.minDiff)) if (w = r.getApparentDifference(q, g, null, !0), !(f || !(this.panEnabled && r.scaleBreaks && r.scaleBreaks._appliedBreaks.length) && (r.logarithmic && w < Math.pow(r.dataInfo.minDiff,
        ...
        m.prototype.renderIndexLabels = function (a) {
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                var h =
                        this._indexLabels[a], n = h.chartType.toLowerCase(), r, q,
                ...
                var p = la("indexLabelFontWeight", h.dataPoint, h.dataSeries),
                    ...
                    f = la("indexLabelWrap", h.dataPoint, h.dataSeries), w = la("indexLabelLineDashType",
                    h.dataPoint, h.dataSeries), k = la("indexLabelLineColor", h.dataPoint, h.dataSeries),
                ...
                if (null !== z && "" !== z) {
                    var t = la("indexLabelPlacement", h.dataPoint, h.dataSeries),
                        x = la("indexLabelOrientation", h.dataPoint, h.dataSeries), F = h.direction,
                        B = h.dataSeries.axisX, C = h.dataSeries.axisY, v = !1, g = new ia(d, {
                            x: 0,
                            y: 0,
                    ...
                    if ("normal" === this.plotInfo.axisPlacement) {
                        if (0 <= n.indexOf("line") || 0 <= n.indexOf("area")) t = "auto", p = 4; else if (0 <= n.indexOf("stacked")) "auto" === t && (t = "inside"); else if ("bubble" === n || "scatter" === n) t = "inside";
                        r = h.point.x -
                            l / 2;
        ...
        m.prototype.renderLine = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var f = [], p, l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    var w = h._colorSet, k = w = h.lineColor = h.options.lineColor ? h.options.lineColor : w[0];
                    c.strokeStyle = w;
                    var m = !0, t = 0, x, s;
                    c.beginPath();
                    if (0 < n.length) {
        ...
        m.prototype.renderStepLine = function (a) {
            var d = a.targetCanvasCtx ||
                this.plotArea.ctx, c = u ? this._preRenderCtx : d;
            if (!(0 >= a.dataSeriesIndexes.length)) {
        ...
        m.prototype.renderSpline = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var p = [], l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    var m = 0, t, x, s = [];
                    b.beginPath();
                    if (0 < n.length) for (x = !1, m = 0; m < n.length; m++) if (t = n[m].getTime ? n[m].x.getTime() : n[m].x, !(t < a.axisX.dataInfo.viewPortMin || t > a.axisX.dataInfo.viewPortMax && (!h.connectNullData || !x))) if ("number" !== typeof n[m].y) 0 < m && !x && (h.connectNullData ? b.setLineDash && (0 < s.length && (h.options.nullDataLineDashType || !n[m - 1].lineDashType)) && (s[s.length - 1].newLineDashArray = q, r = h.nullDataLineDashType) : (d(s), s = [])), x = !0;
                    else {
        ...
        m.prototype.renderColumn = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (n = 0; n < a.dataSeriesIndexes.length; n++) {
                    var q = a.dataSeriesIndexes[n], g = this.data[q], w = g.dataPoints;
                    if (0 < w.length) for (var k = 5 < r && g.bevelEnabled ? !0 : !1, f = 0; f < w.length; f++) if (w[f].getTime ? A = w[f].x.getTime() :
                    ...
                    if (0 < t.length) {
                        ...
                        for (h = 0; h < t.length; h++) if (b = t[h].x.getTime ? t[h].x.getTime() : t[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[h].y) {
                            ...
                            if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[h].y) l[b] = t[h].y + (l[b] ? l[b] : 0), 0 < l[b] && (r = a.axisY.convertValueToPixel(l[b]),
                                B = "undefined" !== typeof f[b] ? f[b] : q, f[b] = r); else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[h].y) A[b] = t[h].y + (A[b] ? A[b] : 0), B = a.axisY.convertValueToPixel(A[b]), r = "undefined" !== typeof p[b] ? p[b] : q, p[b] = B; else if (r = a.axisY.convertValueToPixel(t[h].y), 0 <= t[h].y) {
                            ...
                            ca(c, s, r, F, B, b, 0, null, x && 0 <= t[h].y, 0 > t[h].y && x, !1,
                                !1, m.fillOpacity);
                            b = m.dataPointIds[h];
                            this._eventManager.objectMap[b] = {
                                id: b,
        ...
        m.prototype.renderStackedColumn100 = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var w = 0; w < a.dataSeriesIndexes.length; w++) {
                    var k = a.dataSeriesIndexes[w],
                        m = this.data[k], t = m.dataPoints;
                    if (0 < t.length) for (var x = 5 < g && m.bevelEnabled ? !0 : !1, h = 0; h < t.length; h++) if (b = t[h].x.getTime ? t[h].x.getTime() : t[h].x, !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof t[h].y) {
                        n = a.axisX.convertValueToPixel(b);
                        ...
                        if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[h].y) {
                            ...
                            B = f[b] ? f[b] : q;
                            f[b] = r
                        } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[h].y) A[b] = r + ("undefined" !== typeof A[b] ? A[b] : 0), B = a.axisY.convertValueToPixel(A[b]), r = p[b] ? p[b] : q, p[b] = B; else if (r = a.axisY.convertValueToPixel(r), 0 <= t[h].y) {
                            var C = "undefined" !== typeof f[b] ? f[b] : 0;
                            r -= C;
                            B = q - C;
                        ...
                        this._indexLabels.push({
                            ...
                            point: {x: n, y: 0 <= t[h].y ? r : B},
                            direction: 0 > t[h].y === a.axisY.reversed ? 1 : -1,
                            bounds: {x1: s, y1: Math.min(r, B), x2: F, y2: Math.max(r, B)},
                            color: b
                        })
                    }
                }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (n = 0; n < a.dataSeriesIndexes.length; n++) {
                    ...
                    if (0 < w.length) {
                        ...
                        c.strokeStyle = "#4572A7 ";
                        for (f = 0; f < w.length; f++) if (w[f].getTime ? A = w[f].x.getTime() : A = w[f].x, !(A < a.axisX.dataInfo.viewPortMin || A > a.axisX.dataInfo.viewPortMax) && "number" === typeof w[f].y) {
        ...
        m.prototype.renderStackedBar = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                u && (this._eventManager.ghostCtx.beginPath(), this._eventManager.ghostCtx.rect(e.x1, e.y1, e.width, e.height), this._eventManager.ghostCtx.clip());
                for (var w = 0; w < a.dataSeriesIndexes.length; w++) {
                    var k = a.dataSeriesIndexes[w], m = this.data[k], t = m.dataPoints;
                    if (0 < t.length) {
                        var x = 5 < g && m.bevelEnabled ? !0 : !1;
                        c.strokeStyle = "#4572A7 ";
                        for (h = 0; h < t.length; h++) if (b = t[h].x.getTime ? t[h].x.getTime() :
                            ...
                            if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[h].y) l[b] = t[h].y + (l[b] ? l[b] : 0), 0 < l[b] && (B = f[b] ? f[b] : q, f[b] = n = a.axisY.convertValueToPixel(l[b])); else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= t[h].y) A[b] = t[h].y + (A[b] ? A[b] : 0), n = p[b] ?
                                p[b] : q, p[b] = B = a.axisY.convertValueToPixel(A[b]); else if (n = a.axisY.convertValueToPixel(t[h].y), 0 <= t[h].y) {
                                var C = f[b] ? f[b] : 0;
                                B = q + C;
                                n += C;
                                f[b] = C + (n - B)
                            ...
                            b = P(b);
                            u && ca(this._eventManager.ghostCtx, B, s, n, F, b, 0, null, !1, !1, !1,
                                !1);
                            (t[h].indexLabel || m.indexLabel || t[h].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({
                                ...
                                direction: 0 > t[h].y === a.axisY.reversed ? 1 : -1,
                                bounds: {x1: Math.min(B, n), y1: s, x2: Math.max(B, n), y2: F},
                                color: b
                            })
                        }
                    }
                ...
                for (var w = 0; w < a.dataSeriesIndexes.length; w++) {
                    ...
                    if (0 < t.length) {
                        ...
                        "number" === typeof t[h].y) {
                            ...
                            var F = r - a.plotType.plotUnits.length * g / 2 + a.index * g << 0, B = F + g << 0;
                            if (a.axisY.logarithmic || a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < t[h].y) {
                                l[b] = z + (l[b] ? l[b] : 0);
                                if (0 >= l[b]) continue;
                                z = f[b] ? f[b] : q;
                                ...
                                q, p[b] = z = a.axisY.convertValueToPixel(A[b]); else if (n = a.axisY.convertValueToPixel(z), 0 <= t[h].y) {
                                var C = f[b] ? f[b] : 0;
                                z = q + C;
                                n += C;
                            ...
                            (t[h].indexLabel || m.indexLabel || t[h].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({
                                ...
                                direction: 0 > t[h].y === a.axisY.reversed ? 1 : -1,
                                bounds: {x1: Math.min(z, n), y1: F, x2: Math.max(z, n), y2: B},
                                color: b
                            })
                        }
                    }
        ...
        m.prototype.renderArea = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
                    var q = a.dataSeriesIndexes[r], g = this.data[q], w = g.dataPoints, A = g.id;
                    ...
                    d = !0;
                    var k = 0, m, t, s,
                        z = a.axisY.convertValueToPixel(a.axisY.logarithmic ? a.axisY.viewportMinimum : 0), F, B = null;
                    if (0 < w.length) {
                        var C = g._colorSet[k % g._colorSet.length], v = g.lineColor = g.options.lineColor || C, y = v;
                        f.fillStyle = C;
                        f.strokeStyle = v;
            ...
            function d() {
                ...
                if (0 < c.length) {
                    if (0 < n.lineThickness) {
                        ...
                        for (var d = 0; d < c.length - 3; d += 3) if (b.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y), u && e.bezierCurveTo(c[d + 1].x, c[d + 1].y, c[d + 2].x, c[d + 2].y, c[d + 3].x, c[d + 3].y), c[d + 3].newStrokeStyle || c[d + 3].newLineDashArray) b.stroke(), b.beginPath(),
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var A = 0; A < a.dataSeriesIndexes.length; A++) {
                    ...
                    var p = [], q = 0, g, w,
                        ...
                        s = [];
                    if (0 < r.length) {
                        var z = n._colorSet[q % n._colorSet.length], F = n.lineColor = n.options.lineColor || z, B = F;
                        b.fillStyle = z;
                        b.strokeStyle =
                            F;
                        ...
                        var C = "solid";
                        if (b.setLineDash) {
                            var y = N(n.nullDataLineDashType, n.lineThickness), C = n.lineDashType,
                                D = N(C, n.lineThickness);
                            b.setLineDash(D)
                        }
                        for (w = !1; q < r.length; q++) if (g = r[q].x.getTime ? r[q].x.getTime() : r[q].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax && (!n.connectNullData || !w))) if ("number" !== typeof r[q].y) 0 < q && !w && (n.connectNullData ? b.setLineDash && (0 < s.length && (n.options.nullDataLineDashType || !r[q - 1].lineDashType)) && (s[s.length - 1].newLineDashArray = y,
        ...
        m.prototype.renderStackedArea = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = null, p = [], l = this.plotArea, A = [], h = [], n = [], r = [], q = 0, g, k,
                    ...
                    s = this._eventManager.ghostCtx, t, x, z;
                u && s.beginPath();
                b.save();
                u && s.save();
                b.beginPath();
                ...
                for (var e = [], F = 0; F < a.dataSeriesIndexes.length; F++) {
                    var B = a.dataSeriesIndexes[F], C = this.data[B], v = C.dataPoints;
                    C.dataPointIndexes =
                        [];
                ...
                for (F = 0; F < a.dataSeriesIndexes.length; F++) {
                    ...
                    s.fillStyle = q;
                    if (0 < n.length) {
                        var e = C._colorSet[0], y = C.lineColor = C.options.lineColor || e, S = y;
                        b.fillStyle = e;
                        b.strokeStyle = y;
                        ...
                        for (var Z = !0, q = 0; q < n.length; q++) {
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!C.connectNullData || !Z))) if ("number" !== typeof fa.y) C.connectNullData || (Z || x) || d(), Z = !0; else {
        ...
        m.prototype.renderStackedArea100 = function (a) {
            ...
            var c = a.targetCanvasCtx || this.plotArea.ctx, b = u ? this._preRenderCtx : c;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = null, f = null, p = this.plotArea, l = [], k = [], h = [], n = [], r = [], q = 0, g, w, m, s, t,
                ...
                for (v = 0; v < a.dataSeriesIndexes.length; v++) {
                    ...
                    h = [];
                    if (0 < n.length) {
                        var e = C._colorSet[q % C._colorSet.length], D = C.lineColor = C.options.lineColor || e, S = D;
                        b.fillStyle = e;
                        b.strokeStyle =
                            D;
                        b.lineWidth = C.lineThickness;
                        ...
                        for (var Z = !0, q = 0; q < n.length; q++) {
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax && (!C.connectNullData || !Z))) if ("number" !== typeof fa.y) C.connectNullData || (Z || s) || d(), Z = !0; else {
                                var ma;
            ...
            function (a) {
                ...
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    ...
                    for (var m = 0; m < a.dataSeriesIndexes.length; m++) {
                        var v = a.dataSeriesIndexes[m], t = this.data[v], x = t.dataPoints;
                        if (0 < x.length) for (var z = 5 < w && t.bevelEnabled ? !0 : !1, l = 0; l < x.length; l++) if (x[l].getTime ? g = x[l].x.getTime() : g = x[l].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && !s(x[l].y) && x[l].y.length && "number" === typeof x[l].y[0] && "number" === typeof x[l].y[1] && "number" === typeof x[l].y[2] && "number" === typeof x[l].y[3]) {
                            ...
                            var F = k - w / 2 << 0, B = F + w << 0,
                                f = t.options.fallingColor ? t.fallingColor : t._colorSet[0],
                                e = x[l].color ? x[l].color : t._colorSet[0], C = Math.round(Math.max(1, 0.15 * w)),
                                y = 0 === C % 2 ? 0 : 0.5, D = t.dataPointIds[l];
        ...
        m.prototype.renderBoxAndWhisker = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var m = !1, m = !!a.axisY.reversed, v = 0; v < a.dataSeriesIndexes.length; v++) {
                    var t = a.dataSeriesIndexes[v], x = this.data[t], z = x.dataPoints;
                    if (0 < z.length) for (var F = 5 < w && x.bevelEnabled ? !0 : !1, p = 0; p < z.length; p++) if (z[p].getTime ? g = z[p].x.getTime() : g = z[p].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) &&
                    !s(z[p].y) && z[p].y.length && "number" === typeof z[p].y[0] && "number" === typeof z[p].y[1] && "number" === typeof z[p].y[2] && "number" === typeof z[p].y[3] && "number" === typeof z[p].y[4] && 5 === z[p].y.length) {
                        ...
                        var B = l - w / 2 << 0, C = l + w / 2 << 0, e = z[p].color ? z[p].color : x._colorSet[0],
                            y = Math.round(Math.max(1,
                                0.15 * w)), D = 0 === y % 2 ? 0 : 0.5,
                            ...
                            w ? w : parseInt(Z) * w / 100 : w, fa = 1 === Math.round(R) % 2 ? 0.5 : 0,
                            ...
                            ra = s(x.options.fillOpacity) ? 1 : x.fillOpacity, O = x.dataPointIds[p];
        ...
        m.prototype.renderError = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var x = 0; x < a.dataSeriesIndexes.length; x++) {
                    var z = a.dataSeriesIndexes[x], F = this.data[z], B = F.dataPoints,
                        C = s(F._linkedSeries) ? !1 : F._linkedSeries.type.match(/(bar|column)/ig) && F._linkedSeries.visible ? !0 : !1,
                        D = 0;
                    if (C) for (e = F._linkedSeries.id, t = 0; t < e; t++) !this.data[t].type.match(/(bar|column)/ig) || !this.data[t].visible || this.data[t].type.match(/(stacked)/ig) &&
                    ...
                    t < e && (t = e);
                    t > l && (t = l);
                    if (0 < B.length) for (var E = F._colorSet,
                                               l = 0; l < B.length; l++) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
                    ...
                    if (0 < m.length) {
                        ...
                        c.strokeStyle = "#4572A7 ";
                        for (f = 0; f < m.length; f++) if (m[f].getTime ? h = m[f].x.getTime() : h = m[f].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && !s(m[f].y) && m[f].y.length && "number" === typeof m[f].y[0] && "number" === typeof m[f].y[1]) {
        ...
        m.prototype.renderRangeArea = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    if (0 < r.length) {
                        var z = n._colorSet[g % n._colorSet.length], F = n.lineColor = n.options.lineColor || z, B = F;
                        b.fillStyle = z;
                        b.strokeStyle = F;
                        b.lineWidth = n.lineThickness;
                        var C = "solid";
                        ...
                        for (var S = !0; g < r.length; g++) if (t = r[g].x.getTime ?
                            ...
                            q || S ? (n.connectNullData && !q ? (b.setLineDash && (n.options.nullDataLineDashType || C === n.lineDashType && n.lineDashType !== n.nullDataLineDashType) && (k[k.length - 1].newLineDashArray = D, C = n.nullDataLineDashType,
                                ...
                                y1: s,
                                y2: v
                            })) : (b.beginPath(), b.moveTo(m, s), x = {x: m, y: s}, k = [], k.push({
                                x: m,
                                y1: s,
                                y2: v
        ...
        m.prototype.renderRangeSplineArea = function (a) {
            ...
            var c = a.targetCanvasCtx ||
                this.plotArea.ctx, b = u ? this._preRenderCtx : c;
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var e = this._eventManager.ghostCtx, f = [], p = this.plotArea;
                b.save();
                u && e.save();
                ...
                for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
                    ...
                    var f = [], r = 0, q,
                        g, m, s = [], y = [];
                    if (0 < n.length) {
                        var t = h._colorSet[r % h._colorSet.length], x = h.lineColor = h.options.lineColor || t, z = x;
                        b.fillStyle = t;
                        b.lineWidth = h.lineThickness;
                        var F = "solid", B;
                        if (b.setLineDash) {
                            var C = N(h.nullDataLineDashType, h.lineThickness), F = h.lineDashType;
        ...
        m.prototype.renderWaterfall = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
                    var m =
                        a.dataSeriesIndexes[g], s = this.data[m], v = s.dataPoints, e = s._colorSet[0];
                    ...
                    if (0 < v.length) for (var z = 5 < q && s.bevelEnabled ? !0 : !1, F = !1, B = null, C = null, p = 0; p < v.length; p++) if (v[p].getTime ? n = v[p].x.getTime() : n = v[p].x, "number" !== typeof v[p].y) {
        ...
        m.prototype.renderPie = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                var h = this.data[a.dataSeriesIndexes[0]], n = h.dataPoints, r = 10, q = this.plotArea,
                    g = h.dataPointEOs, m = 2, u, v = 1.3, t = 20 / 180 * Math.PI, x = 6,
                    z = {x: (q.x2 + q.x1) / 2, y: (q.y2 + q.y1) / 2}, y = 0;
                a = !1;
        ...
        m.prototype.renderFunnel = function (a) {
            ...
            function f() {
                var a, b, c, d;
                if ("inside" !== t.indexLabelPlacement) for (var e = 0; e < O.length; e++) 0 == H[e].textBlock.text.length ?
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                var R = z.x1 + B, M = z.x2 - B, Z = z.y1 + F, Q = z.y2 - F,
                ...
                if (0 != t.length && (t.dataPoints && t.visible) && 0 !== x.length) {
                    ...
                    var B = R + a / 2, W = R, $ = R + a, T = t.reversed ? Q : Z, K = B - G / 2, X = B + G / 2,
                        wa = t.reversed ? Z + ba : Q - ba, ra = t.reversed ? Z : Q;
                    a = [];
                    var B = [], O = [], E = [], U = Z, ca, aa = (wa - T) / (K - W), ea = -aa,
                        R = "area" === (t.valueRepresents ? t.valueRepresents : "height") ? c() : d();
                    if (-1 !== R) {
                        if (t.reversed) for (E.push(U), G = R.length - 1; 0 < G; G--) U += R[G], E.push(U); else for (G = 0; G < R.length; G++) U += R[G], E.push(U);
                        if (t.reversed) for (G =
                                                 0; G < R.length; G++) E[G] < wa ? (a.push(K), B.push(X), ca = G) : (a.push((E[G] - T + aa * W) / aa), B.push((E[G] - T + ea * $) / ea)); else for (G = 0; G < R.length; G++) E[G] < wa ? (a.push((E[G] - T + aa * W) / aa), B.push((E[G] - T + ea * $) / ea), ca = G) : (a.push(K), B.push(X));
                        ...
                        if (!I) for (G = 0; G < x.length; G++) C = t.dataPointIds[G], a = {
                            id: C,
                            objectType: "dataPoint",
                            dataPointIndex: G,
                            dataSeriesIndex: 0,
            ...
            for (var n = 0; n < this.dataSeries.length; n++) {
                ...
                if (r.dataPoints && r.dataPoints.length) if ("pie" !== r.type && "doughnut" !== r.type && "funnel" !== r.type && "pyramid" !== r.type) {
                    ...
                    var z = r.dataPoints[x],
                        ...
                        g = this.chart.replaceKeywordsWithValue(g, z, r, x), q = {
                            markerType: q,
                            markerColor: m,
                            text: g,
                            textBlock: null,
                ...
                for (var h = p[k], n = 0, r = 0; r < h.items.length; r++) {
                    ...
                    if ("error" === q.chartType) {
                        ...
                        var u = g - 0.08 * this.lineHeight + 0.1 * this.lineHeight,
                            t = m + 0.15 * this.lineHeight, x = 0.7 * this.lineHeight, v = x + 0.02 * this.lineHeight;
                        this.ctx.moveTo(u, t);
        ...
        D.prototype.createLabels = function () {
            ...
            e = [];
            q = r = 0;
            if (this.labelAutoFit || this.options.labelAutoFit) if (s(this.labelAngle) || (this.labelAngle = (this.labelAngle % 360 + 360) % 360, 90 < this.labelAngle && 270 > this.labelAngle ? this.labelAngle -= 180 : 270 <= this.labelAngle && 360 >= this.labelAngle && (this.labelAngle -= 360)), "bottom" === this._position || "top" === this._position) if (f = 0.9 * l >> 0, q = 0, !this.chart.panEnabled && 1 <=
            this._labels.length) {
        ...
        D.setLayout = function (a, d, c, b, e, f) {
            ...
            for (g = 0; g < q.length; g++) if (q[g] && q[g].scaleBreaks && q[g].scaleBreaks._appliedBreaks.length) for (var m = q[g].scaleBreaks._appliedBreaks, u = 0; u < m.length && !(m[u].startValue > q[g].viewportMaximum); u++) m[u].endValue < q[g].viewportMinimum || (s(q[g].scaleBreaks.firstBreakIndex) &&
            ...
            if ("normal" === e) {
                for (var x = [], z = [], y = [], B = [], M = [], N = [], P = [], Q = []; 4 > u;) {
                    ...
                    if (c && 0 < c.length) for (y = [], g = O = 0; g < c.length; g++) y.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateWidth() : 0)), O += y[g], K += c[g] && !n.isNavigator ? c[g].margin : 0; else y.push(Math.ceil(c[0] ?
                    ...
                    M.push(x);
                    if (d && 0 < d.length) for (z = [], g = X = 0; g < d.length; g++) d[g] && (d[g].lineCoordinates = {}), d[g].lineCoordinates.width = Math.abs(k - p), d[g].title && (d[g]._titleTextBlock.maxWidth = 0 < d[g].titleMaxWidth && d[g].titleMaxWidth <
                    d[g].lineCoordinates.width ? d[g].titleMaxWidth : d[g].lineCoordinates.width), z.push(Math.ceil(d[g] ? d[g].createLabelsAndCalculateHeight() : 0)), X += z[g], Y += d[g] && !n.isNavigator ? d[g].margin : 0; else z.push(Math.ceil(d[0] ? d[0].createLabelsAndCalculateHeight() : 0));
                    N.push(z);
                    ...
                    if (d && 0 < d.length) for (g = 0; g < d.length; g++) d[g].calculateValueToPixelConversionParameters(), d[g].calculateBreaksSizeInValues(), d[g]._labels && 1 < d[g]._labels.length && (C = (d[g].logarithmic ? Math.log(d[g]._labels[1].position / d[g].viewportMinimum) / d[g].conversionParameters.lnLogarithmBase : d[g]._labels[1].position - d[g].viewportMinimum) * Math.abs(d[g].conversionParameters.pixelPerUnit) + d[g].lineCoordinates.x1,
                    ...
                    if (0 <
                        u) {
                        if (a && 0 < a.length) for (g = 0; g < a.length; g++) m = M[u - 1][g] === M[u][g] ? !0 : !1; else m = !0;
                        if (d && 0 < d.length) for (g = 0; g < d.length; g++) I = N[u - 1][g] === N[u][g] ? !0 : !1; else I = !0;
                        if (c && 0 < c.length) for (g = 0; g < c.length; g++) J = P[u - 1][g] === P[u][g] ? !0 : !1; else J = !0;
                        if (b && 0 < b.length) for (g = 0; g < b.length; g++) L = Q[u - 1][g] === Q[u][g] ? !0 : !1; else L = !0
                    }
                    if (m && I && J && L) break;
                    u++
                }
                ...
                for (N = []; 4 > u;) {
                    ...
                    if (a && 0 < a.length) for (E = [], g = W = 0; g < a.length; g++) E.push(Math.ceil(a[g] ? a[g].createLabelsAndCalculateWidth() : 0)), W += E[g], e += a[g] && !n.isNavigator ? a[g].margin : 0; else E.push(Math.ceil(a[0] ?
                    ...
                    N.push(v);
                    if (c && 0 < c.length) for (g = 0; g < c.length; g++) c[g].lineCoordinates = {}, p = Math.round(f.x1 + W + e), k = Math.round(f.x2 - U - Y > n.width - 10 ? n.width - 10 : f.x2 - U - Y), c[g].labelAutoFit && !s(x) && (0 < !a.length && (p = 0 > c[g].labelAngle ? Math.max(p, x) : 0 === c[g].labelAngle ?
                    ...
                    D.push(r);
                    if (b && 0 < b.length) for (C = [], g = V = 0; g < b.length; g++) C.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateHeight() : 0)), V += C[g], $ += b[g].margin; else C.push(Math.ceil(b[0] ? b[0].createLabelsAndCalculateHeight() : 0));
                    t.push(C);
                    ...
                    if (b && 0 < b.length) for (g = 0; g < b.length; g++) b[g] && 0 < b[g]._labels.length && (h = b[g]._labels[0], l = b[g]._labels[b[g]._labels.length - 1], y = h.textBlock.width * Math.cos(Math.PI / 180 * Math.abs(h.textBlock.angle)) + (h.textBlock.height - l.textBlock.fontSize / 2) * Math.sin(Math.PI /
                    ...
                    if (n.panEnabled) for (g = 0; g < c.length; g++) r[g] = s(n.sessionVariables.axisY.height) ? n.sessionVariables.axisY.height = r[g] : n.sessionVariables.axisY.height; else for (g = 0; g < c.length; g++) n.sessionVariables.axisY.height = r[g];
                    ...
                    if (b && 0 < b.length) for (g = b.length - 1; 0 <= g; g--) b[g] && (l = Math.round(f.y1), h = Math.round(f.y1 + (C[g] + b[g].margin + G)), b[g].lineCoordinates.y1 = h, b[g].lineCoordinates.y2 = h, "inside" === b[g].labelPlacement && 0 < g && (b[g].lineCoordinates.y1 = h - C[g] + (b[g]._titleTextBlock ? b[g]._titleTextBlock.height : 0)), b[g].bounds = {
                        x1: p,
                        y1: l + (b[g].margin + G),
                        x2: k,
                        y2: h,
                    ...
                    if (0 < u) {
                        ...
                        if (b && 0 < b.length) for (g = 0; g < b.length; g++) L = t[u - 1][g] === t[u][g] ? !0 : !1; else L = !0
                    }
                    if (m && I && J && L) break;
                    u++
                }
        ...
        D.prototype.renderAxisLine = function () {
            var a =
                    this.chart.ctx, d = u ? this.chart._preRenderCtx : a,
            ...
            if ("bottom" === this._position || "top" === this._position) {
                ...
                d.beginPath();
                if (this.scaleBreaks && !s(this.scaleBreaks.firstBreakIndex)) if (s(this.scaleBreaks.lastBreakIndex)) e =
        ...
        D.prototype.calculateAxisParameters = function () {
            if (this.logarithmic) this.calculateLogarithmicAxisParameters(); else {
                ...
                if (this.scaleBreaks) for (b = 0; b < this.scaleBreaks._appliedBreaks.length; b++) if ((!s(this.sessionVariables.newViewportMinimum) &&
        ...
        aa.prototype.render = function (a, d, c) {
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    var u = null;
                    if ("bottom" === this.parent._position || "top" === this.parent._position) w = this.parent.dataSeries[0].axisX.convertPixelToValue({y: d}); else if ("left" === this.parent._position || "right" === this.parent._position) w =
                    ...
                    v = 0;
                    if ("rangeBar" === n[0].dataSeries.type || "error" === n[0].dataSeries.type) for (var u = Math.abs(a - this.parent.convertValueToPixel(n[v].dataPoint.y[0])),
                    ...
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        ...
                        if (this.parent.labels) for (n =
                                                         Math.ceil(this.parent.interval), w = 0; w < this.parent.viewportMaximum; w += n) if (this.parent.labels[w]) y = !0; else {
                            y = !1;
                            break
                        }
                        if (y) {
                            if ("axisX" === this.parent.type) for (w = this.parent.convertPixelToValue({y: d}), u = null, v = 0; v < this.parent.dataSeries.length; v++) (u = this.parent.dataSeries[v].getDataPointAtX(w, !0)) && 0 <= u.index && (h.text = this.labelFormatter ? this.labelFormatter({
                                chart: this.chart,
                                axis: this.parent.options,
                                crosshair: this.options,
                                value: x.dataPoint.x
                    ...
                    this.bounds = {x1: b - r / 2, y1: f, x2: e + r / 2, y2: k};
                    y = !1;
                    if (this.parent.labels) for (n = Math.ceil(this.parent.interval), w = 0; w < this.parent.viewportMaximum; w += n) if (this.parent.labels[w]) y = !0; else {
                        y = !1;
                        break
                    }
                    if (y) {
                        if ("axisX" === this.parent.type) for (w = this.parent.convertPixelToValue({x: a}), u = null, v = 0; v < this.parent.dataSeries.length; v++) (u = this.parent.dataSeries[v].getDataPointAtX(w, !0)) && 0 <= u.index && (h.text = this.labelFormatter ? this.labelFormatter({
                                chart: this.chart,
                                axis: this.parent.options,
                                crosshair: this.options,
                                value: x.dataPoint.x
                    ...
                    if ("rangeColumn" === n[0].dataSeries.type || "rangeArea" === n[0].dataSeries.type || "error" === n[0].dataSeries.type || "rangeSplineArea" ===
                        ...
                        n[w].dataPoint.y.length) for (x = 0; x < n[w].dataPoint.y.length; x++) t = Math.abs(d - this.parent.convertValueToPixel(n[w].dataPoint.y[x])), t < u && (u = t, v = w); else t = Math.abs(d - this.parent.convertValueToPixel(n[w].dataPoint.y)), t < u && (u = t, v = w);
                    x = n[v];
                    b = 0;
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) if ("left" === this.parent._position || "right" === this.parent._position) {
                    ...
                    if (y) {
                        if ("axisX" ===
                            this.parent.type) for (w = this.parent.convertPixelToValue({y: d}), u = null, v = 0; v < this.parent.dataSeries.length; v++) (u = this.parent.dataSeries[v].getDataPointAtX(w, !0)) && 0 <= u.index && (h.text = this.labelFormatter ? this.labelFormatter({
                            chart: this.chart,
                            axis: this.parent.options,
                            crosshair: this.options,
            ...
            if (!this.chart.disableToolTip) {
                ...
                if (this.shared && this.enabled && "none" !== this.chart.plotInfo.axisPlacement) {
                    ...
                    if (0 <= this.currentSeriesIndex) {
                        ...
                        if (!s(h) && !s(h.dataPoint) && !s(h.dataPoint.y)) if (h.dataSeries.axisY) if (0 <
