        ...
        public static async Task Main(string[] args)
        {
            ...
            var benchmarks = new Func<int, Task>[]
            {
                i => RunBenchmark(i,
                    ...
                    edgeChance: chance,
                    termination: a => new TimeoutTermination<IBitIndividual, bool[], bool>(timeBudget),
                    mu: 1, lambda: 1,
                ...
                i => RunBenchmark(i,
                    ...
                    stepSize: stepSize, steps: steps, seed: seed,
                    edgeChance: chance2,
                    termination: a => new FitnessCallsTermination<IBitIndividual, bool[], bool>(fitnessCallsBudget),
                    mu: 1, lambda: 1,
                    mutationRate: 1, learningRate: 0.1, observationPhase: 50,
                    budget: fitnessCallsBudget
                ),
        ...
        public static async Task MainSatisfiability(string[] args)
        {
            ...
            var benchmarks = new Func<int, Task>[]
            {
                i => RunBenchmark(i,
                    ...
                    termination: a =>
                        new BudgetOrBeforeTermination<IBitIndividual, bool[], bool>(budget,
