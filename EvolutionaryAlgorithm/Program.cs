    ...
    public static class Program
    {
        ...
        public static async Task Main(string[] args)
        {
            ...
            var benchmarks = new Func<int, Task>[]
            {
                ...
                i => RunBenchmark(i, heuristic: HeavyTail, fitness: OneMax, stepSize: 1000, mu: 1,
                    lambda: 1,
                    beta: 1.5,
                    mutationRate: 2,
                    learningRate: 1),
                ...
                i => RunBenchmark(i, heuristic: StagnationDetection, fitness: OneMax, stepSize: 1000, mu: 1,
                    lambdaString: "ln n",
                    lambdaFunc: n => (int) Math.Ceiling(Math.Log(n)),
                    mutationRate: 2,
                    learningRate: 2),

                i => RunBenchmark(i, heuristic: StagnationDetection, fitness: LeadingOnes, stepSize: 100, mu: 1,
                    lambdaString: "ln n",
                    lambdaFunc: n => (int) Math.Ceiling(Math.Log(n)),
                    mutationRate: 2,
                    learningRate: 2),
